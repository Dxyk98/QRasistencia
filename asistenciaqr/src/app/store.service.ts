...
export class StoreService {
  ...
  async saveClassData(uid: string, classData: any) {
    try {
      await this.firestore.collection('Class').doc(uid).set(classData);
  ...
  getProfesores() {
    return this.firestore
      .collection('Users', (ref) => ref.where('profesion', '==', 'profesor'))
      .valueChanges();
  }
}
